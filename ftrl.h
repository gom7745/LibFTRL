...
public:
    ...
    bool normalized, verbose, freq, auto_stop, no_auc;
    Parameter():l1(0.1), l2(0.1), alpha(0.1), beta(1), normalized(false),verbose(true), freq(true), auto_stop(false), no_auc(false), nr_threads(1){};
};
